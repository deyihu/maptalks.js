...
import * as commonUtil from './core/util/common';
import * as envUtil from './core/util/env';
import * as utilUtil from './core/util/util';
import * as resourceUtil from './core/util/resource';
import * as styleUtil from './core/util/style';
